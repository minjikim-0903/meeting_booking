...
export const people: Person[] = [
  { id: "p1", name: "김도윤", email: "dowoon.kim@company.com", role: "프로덕트 오너", team: "서비스1팀" },
  { id: "p2", name: "박서연", email: "seoyeon.park@company.com", role: "프로덕트 오너", team: "서비스2팀" },
  { id: "p3", name: "이준호", email: "junho.lee@company.com", role: "개발자", team: "서비스1팀" },
  { id: "p4", name: "최민지", email: "minji.choi@company.com", role: "개발자", team: "서비스2팀" },
  { id: "p5", name: "정하늘", email: "haneul.jung@company.com", role: "데이터 분석가", team: "서비스3팀" },
  { id: "p6", name: "강태양", email: "taeyang.kang@company.com", role: "데이터 분석가", team: "서비스4팀" },
  { id: "p7", name: "윤소희", email: "sohee.yoon@company.com", role: "프로덕트 디자이너", team: "서비스3팀" },
  { id: "p8", name: "한지훈", email: "jihoon.han@company.com", role: "프로덕트 디자이너", team: "서비스4팀" },
  { id: "p9", name: "오하준", email: "hajoon.oh@company.com", role: "개발자", team: "서비스5팀" },
  { id: "p10", name: "배지수", email: "jisu.bae@company.com", role: "기획 PM", team: "서비스5팀" },
  { id: "p11", name: "서은우", email: "eunwoo.seo@company.com", role: "데이터 분석가", team: "서비스5팀" },
]
